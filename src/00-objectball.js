...
//       let longestName = "";
//       for (let player in players) {
//             if (players[player].name.length > longestName.length) {
//                   longestName = players[player].name;
//             }
//       }
...
//             }
//       }
//       //return true if the player with the longest name is the player with the most steals
